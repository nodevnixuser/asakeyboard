...
declare -A hid_usage_id=(
    ...
    ["0x20"]="0x2c"  # Space tuşu
    ["0x08"]="0x2a"  # Backspace tuşu
    ["0x09"]="0x2b"  # Tab tuşu
    ["0x2d"]="0x2d"  # Dash/Minus tuşu
    ["0x3d"]="0x2e"  # Equal tuşu
    ["0x5b"]="0x2f"  # Left bracket [
    ["0x5d"]="0x30"  # Right bracket ]
    ["0x5c"]="0x31"  # Backslash \
    ["0x3b"]="0x33"  # Semicolon ;
    ["0x27"]="0x34"  # Apostrophe '
    ["0x60"]="0x35"  # Grave accent `
    ["0x2c"]="0x36"  # Comma ,
    ["0x2e"]="0x37"  # Period .
    ["0x2f"]="0x38"  # Slash /
)
